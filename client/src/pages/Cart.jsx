            ...
            {products.length === 0 ? (
              ...
              <Wrapper>
                ...
                <Right>
                  ...
                  Payment Details:
                  <div>
                    <TextInput2 small placeholder="Card Number" />
                    <div
                      style={{
                        display: "flex",
                        gap: "6px",
                    ...
                    >
                      <TextInput2 small placeholder="Expiry Date" />
                      <TextInput2 small placeholder="CVV" />
                    </div>
                    <TextInput2 small placeholder="Card Holder name" />
                  </div>
                </Delivery>
                  <Button
                    text="Place Order"
